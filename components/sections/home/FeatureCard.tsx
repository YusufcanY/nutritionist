...
export default function FeatureCard({
  ...
  return (
    <div className='flex h-full flex-col'>
      {subtitle && (
        <span className='translate-y-1/3 text-7xl font-bold text-dark-green-40 laptop:text-8xl desktop:text-9xl'>
          {subtitle}
        </span>
      )}
      <div
        className={cn(
          'relative z-10 flex-grow rounded-lg border border-green-85 bg-green-95 p-6 laptop:p-8 desktop:rounded-xl desktop:p-10',
          className
        )}
      >
