  ...
  return (
    <section>
      <div className='grid grid-cols-2 laptop:gap-12'>
        <div className='relative col-span-2 grid place-content-center overflow-hidden rounded-b-3xl bg-[#D5E6A9] pt-16 laptop:col-span-1 laptop:rounded-br-4xl laptop:rounded-bl-none laptop:pt-32'>
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          <motion.div
            ...
            className='relative z-10 size-[300px] laptop:size-[500px]'
          >
            <Image
        ...
        <div className='col-span-2 mx-auto flex max-w-3xl flex-col items-center justify-center laptop:col-span-1 laptop:mx-0 laptop:items-start'>
          ...
          >
            <motion.h4
              ...
              className='text-lg font-semibold text-dark-green-15 laptop:text-2xl desktop:text-3xl'
            >
          ...
          <TextAnimate
            animation='slideUp'
            by='word'
            className='mt-4 text-center text-4xl font-bold text-dark-green-15 laptop:text-left laptop:text-5xl desktop:text-6xl'
          >
          ...
          <motion.p
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.3 }}
            className='mt-5 text-center text-sm font-medium laptop:text-left laptop:text-base desktop:text-lg'
          >
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.3 }}
            className='relative z-20 order-first -mt-7 mb-8 flex flex-col items-center gap-2 laptop:order-none laptop:mt-12 laptop:mb-0 laptop:flex-row'
          >
